...
- 2026-08-04 · radar · blog · Nigeria hotel operators posted N14.6bn combined PAT in H1 2026, highest in five years. Hospitality procurement still runs on phone-call approvals and a monthly spreadsheet. Revenue growth on a fragmented system makes the leaks bigger.
- 2026-08-04 · radar · blog · AI in procurement is at 94% weekly adoption and 4% at scale. The gap is fragmented data. Nigerian SME operators face the identical problem: WhatsApp approvals, one spreadsheet per supplier, separate accounting. The AI cannot fix what the connected system has not built yet.
- 2026-08-04 · radar · blog · Nigeria non-oil exports up 39% in Q1 2026 and export containers nearly doubled. Agro traders that can produce origin certificates and buyer documentation fast take disproportionate share of the window.
