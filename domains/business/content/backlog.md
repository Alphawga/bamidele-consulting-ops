...
- 2026-07-23 · radar · blog · NRS gave large Nigerian businesses (N5bn+ turnover) until July 31 to go live on the national e-invoicing platform. This is a connected-records mandate, not a digital upgrade: if your accounting system and your suppliers are not wired to the EFS, you fail validation and face enforcement. The argument Bamidele makes to procurement clients now has a statutory deadline.
- 2026-07-23 · radar · blog · CBN held rates at 26.5% on July 21, not because Nigerian inflation data was bad (it improved) but because of the US-Iran conflict. Nigeria's cost of credit now moves on geopolitical signals 10,000km away. The businesses that keep their financial and operational picture in one place can respond to this kind of shock; the ones pulling numbers from three separate tools cannot.
- 2026-07-23 · radar · blog · SAP is shipping 200 AI agents by year-end and simultaneously warning about "agentic chaos": only 14% of enterprises have governance structures to run agents safely. Companies deploying agents on top of fragmented ERP and procurement data are building the chaos SAP is naming. Data integrity before automation, same argument as always.
